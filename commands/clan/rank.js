module.exports = {
    ...
    Run: async(Service, message, args)=>{
        if (!args) return Service.Utils.ReturnMessage(message, `nusaRoblox.Clan |  Rank`,`Requires 3 parameters.`, [{name:"Format", value:`${Service.Settings.Prefix}${Service.Command.Name} ${Service.Command.Usage}`}]);
